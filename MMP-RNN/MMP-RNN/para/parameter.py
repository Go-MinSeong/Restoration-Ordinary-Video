...
class Parameter:
    ...
    def extract_args(self):
        ...
        # data parameters
        self.parser.add_argument('--data_root', type=str, default='/home/kms990321/DiffBIR/project/data/frames_color_after', help='the path of dataset')
        ...
        self.parser.add_argument('--patch_size', type=int, nargs='*', default=[360, 360])
        ...
        self.parser.add_argument('--test_frames', type=int, default=512,
