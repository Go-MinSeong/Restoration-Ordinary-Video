...
class Trainer:
    def __init__(self, args, train_loader, test_loader, my_model, my_loss, start_epoch=0):
        ...
        self.result_dir = args.out_dir + '/result_vimeo_fc' 
        self.ckpt_dir = args.out_dir + '/checkpoint_vimeo_fc'
        ...
        self.logfile = open(args.out_dir + '/log_vimeo_fc.txt', 'a') # append 모드로
