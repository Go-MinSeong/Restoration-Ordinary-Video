...
parser.add_argument('--out_dir', type=str, default='/home/work/capstone/Go_AdaCoF/Go_output_adacof_train/vimeo_origin')
...
def main():
    ...
    #dataset = DBreader_Dancing(args.train, center_crop=(args.patch_size, args.patch_size))
