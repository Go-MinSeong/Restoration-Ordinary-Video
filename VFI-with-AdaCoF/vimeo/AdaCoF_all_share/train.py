...
from trainer_vimeo_final import Trainer # trainer에서 Trainer 함수 import
...
# parameters
# Model Selection
parser.add_argument('--model', type=str, default='adacofnet_final') # 여기서 모델 디렉토리에서 어떤 걸 불러올지 정의.
...
parser.add_argument('--out_dir', type=str, default='./output_adacof_vimeo_final')
...
def main():
    ...
    with open(args.out_dir + '/config_big_flow_final.txt', 'a') as f:
        f.write(now + '\n\n')
