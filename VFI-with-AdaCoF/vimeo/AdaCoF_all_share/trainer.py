...
class Trainer:
    def __init__(self, args, train_loader, test_loader, my_model, my_loss, start_epoch=0):
        ...
        self.result_dir = args.out_dir + '/result_vimeo_flow_final' 
        self.ckpt_dir = args.out_dir + '/checkpoint_vimeo_flow_final'
        ...
        self.logfile = open(args.out_dir + '/log_vimeo_flow_final.txt', 'a')
