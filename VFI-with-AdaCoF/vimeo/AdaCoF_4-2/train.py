...
from trainer_vimeo_flow_concat_convolution import Trainer # trainer에서 Trainer 함수 import
...
parser.add_argument('--out_dir', type=str, default='./output_adacof_vimeo_flow_convolution_train')
# parser.add_argument('--load', type=str, default=None)
parser.add_argument('--load', type=str, default='./output_adacof_vimeo_flow_convolution_train/checkpoint_big_flow_concat_convolution/model_epoch050.pth')
...
def main():
    ...
    dataset = DBreader_Vimeo90k(args.train, random_crop=(args.patch_size, args.patch_size)) # random_crop으로 변경, resize는 필요없음.
    TestDB = Vimeo_test(args.test_input) # 수정
    ...
    with open(args.out_dir + '/config_vimeo_flow_concat_convolution.txt', 'a') as f:
        f.write(now + '\n\n')
