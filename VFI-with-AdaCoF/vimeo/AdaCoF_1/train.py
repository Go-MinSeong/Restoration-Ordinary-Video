...
from trainer_v import Trainer # trainer에서 Trainer 함수 import
...
parser.add_argument('--load', type=str, default='./output_adacof_train/checkpoint_v/model_epoch050.pth')
...
def main():
    ...
    with open(args.out_dir + '/config_v.txt', 'a') as f:
        f.write(now + '\n\n')
