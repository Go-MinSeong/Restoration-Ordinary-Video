...
class KernelEstimation(torch.nn.Module):
    def __init__(self, kernel_size):
        ...
        self.modulePool1 = torch.nn.Conv2d(in_channels=64, out_channels=64, kernel_size=2, stride=2)

        self.moduleConv4 = Basic(64, 128) # 128,256 -> 64,128
        self.modulePool1 = torch.nn.Conv2d(in_channels=128, out_channels=128, kernel_size=2, stride=2)

        self.moduleConv5 = Basic(128,256) # 256,512 -> 128,256
        self.modulePool1 = torch.nn.Conv2d(in_channels=256, out_channels=256, kernel_size=2, stride=2)
