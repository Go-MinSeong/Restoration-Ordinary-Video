...
parser.add_argument("--data_root_val", default="/home/kms990321/DiffBIR/project/data/frames_color_before", type=str)

parser.add_argument("--gpu_ids", type=str, default="0,1", help="separate by comma")
parser.add_argument("--workers", type=int, default=4)
parser.add_argument("--batch_size", type=int, default=8)
parser.add_argument("--image_size", type=int, default=[360, 360])
parser.add_argument("--video_size", type=int, default=[360, 360])   #536*960  268*480
parser.add_argument("--test_video_size", type=int, default=[360, 360]) 
