...
def define_imglist(opt):
    png_files = [f for f in os.listdir(opt.videopath) if f.endswith('.png')]
    return png_files
...
if __name__ == "__main__":
    ...
    parser.add_argument('--videopath', type = str, \
            default = '/home/kms990321/DiffBIR/project/frames_color_before', \
                help = 'testing video folder path')
    parser.add_argument('--savepath', type = str, default = '/home/kms990321/DiffBIR/project/frames_color_after', help = 'saving folder path')
    parser.add_argument('--load_name', type = str, \
        default = '/home/kms990321/DiffBIR/project/VCGAN/train/model1_Second_Stage_epoch500_bs1_448p.pth', \
            help = 'load the pre-trained model with certain epoch')
    parser.add_argument('--crop_size_h', type = int, default = 512, help = 'single patch size') # 448, 256
    parser.add_argument('--crop_size_w', type = int, default = 512, help = 'single patch size') # 832, 448
    ...
    # PWC-Net parameter
    parser.add_argument('--pwcnet_path', type = str, default = '/home/kms990321/DiffBIR/project/VCGAN/train/trained_models/pwcNet-default.pytorch', help = 'the path that contains the PWCNet model')
    ...
    imglist = sorted(define_imglist(opt))
