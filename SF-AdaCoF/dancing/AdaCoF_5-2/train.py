...
from trainer_big_flow_b_fc import Trainer # trainer에서 Trainer 함수 import
...
parser.add_argument('--load', type=str, default='./output_adacof_train/checkpoint_big_flow_b_fc/model_epoch050.pth')
...
def main():
    ...
    with open(args.out_dir + '/config_big_flow_b_fc.txt', 'a') as f:
        f.write(now + '\n\n')
