...
class KernelEstimation(torch.nn.Module):
    def __init__(self, kernel_size):
        ...
        self.modulePool1 = torch.nn.Conv2d(in_channels=32, out_channels=32, kernel_size=2, stride=2)

        self.moduleConv2 = Basic(32, 64)
        self.modulePool2 = torch.nn.Conv2d(in_channels=64, out_channels=64, kernel_size=2, stride=2)

        self.moduleConv3 = Basic(64, 128)
        self.modulePool3 = torch.nn.Conv2d(in_channels=128, out_channels=128, kernel_size=2, stride=2)

        self.moduleConv4 = Basic(128, 256)
        self.modulePool4 = torch.nn.Conv2d(in_channels=256, out_channels=256, kernel_size=2, stride=2)

        self.moduleConv5 = Basic(256, 512)
        self.modulePool5 = torch.nn.Conv2d(in_channels=512, out_channels=512, kernel_size=2, stride=2)
