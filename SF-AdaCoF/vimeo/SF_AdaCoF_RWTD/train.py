...
parser.add_argument('--train', type=str, default='/home/work/capstone/vimeo_triplet') # 추가한 부분
parser.add_argument('--out_dir', type=str, default='/home/work/capstone/Go_AdaCoF/Go_output_adacof_train/vimeo_concat')
parser.add_argument('--load', type=str, default=None)
parser.add_argument('--test_input', type=str, default='/home/work/capstone/vimeo_triplet')
